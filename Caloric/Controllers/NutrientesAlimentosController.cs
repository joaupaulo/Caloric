...
namespace Caloric.Controllers
{
    public class NutrientesAlimentosController : Controller
    {
        ...
        public NutrientesAlimentosController(CaloricContexto context)
        {
            _context = context;
        }
        ...
        {
            var caloricContexto = _context.NutrientesAlimentos.Include(n => n.Alimentos).Include(n => n.Nutrientes);
            return View(await caloricContexto.ToListAsync());
        }
